...
public class TeacherShift1DetailsActivity extends AppCompatActivity {
    ...
    private DatabaseReference root = db.getReference().child("Shift 09:00 AM to 12:00 PM");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher_shift1_details);
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TeacherShift1DetailsActivity.this, MainActivity.class));
            }
        });
            ...
            public void onClick(View view) {
                ...
                root.push().setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(TeacherShift1DetailsActivity.this, "Data Submit Succesfully", Toast.LENGTH_SHORT).show();
                    }
                });
