...
public class StudentCDDetailsActivity extends AppCompatActivity {
    ...
    private DatabaseReference root = db.getReference().child("CD");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_cddetails);
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(StudentCDDetailsActivity.this, MainActivity.class));
            }
        });
            ...
            public void onClick(View view) {
                ...
                root.push().setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(StudentCDDetailsActivity.this, "Data Submit Succesfully", Toast.LENGTH_SHORT).show();
                    }
                });
